...
namespace BiliSaber {
  ...
  public class Plugin {
    ...
    // public const string HarmonyId = "com.github.YourGitHub.BiliSaber";
    // internal static HarmonyInstance harmony => HarmonyInstance.Create(HarmonyId);

    internal static Plugin instance { get; private set; }
    internal static string Name => "BiliSaber";
    internal static BiliSaberController PluginController => BiliSaberController.instance;
    ...
    */
    ...
    public void OnEnable () {
      new GameObject("BiliSaberController").AddComponent<BiliSaberController>();
      //ApplyHarmonyPatches();
    }
